...
pic: 23
type: Java
desc: 将一个复杂对象的构建与它的表示分离，它允许用户只通过指定复杂对象的类型和内容就可以构建它们，用户不需要知道内部的具体构建细节。建造者模式属于对象创建型模式。...
---
...
![image](https://mr-lanlin.github.io/images/1/建造者模式通用.png)
...
<p>上一篇：<a href="https://mr-lanlin.github.io/2020/05/10/设计模式-解释器模式.html">设计模式-解释器模式（Interpreter）</a></p>

<p>下一篇：<a href="https://mr-lanlin.github.io/2020/06/10/设计模式-观察者模式.html">设计模式-观察者模式（Observer）</a></p>